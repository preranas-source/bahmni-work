...
public class AccessionNumberValidatorFactory {
	...
	public IAccessionNumberValidator getValidator() throws LIMSInvalidConfigurationException{
		...
		}else if( accessionFormat.equals("ALPHASITEYEARNUM")){
			return getAlphaSiteYearValidator();
	...
	private IAccessionNumberValidator getAlphaSiteYearValidator() {
		if( validator == null){
			validator = new AlphaSiteYearAccessionValidator();
		}
