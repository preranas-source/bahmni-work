...
angular.module('consultation', ['ui.router', 'bahmni.clinical', 'bahmni.clinical.swastik', 'bahmni.common.config', 'bahmni.common.patient',
...
angular.module('consultation')
    .config(['$stateProvider', '$httpProvider', '$urlRouterProvider', '$bahmniTranslateProvider', '$compileProvider',
        function ($stateProvider, $httpProvider, $urlRouterProvider, $bahmniTranslateProvider, $compileProvider) {
            // Swastik Clinical as default; use /default/patient/search for original Bahmni
            $urlRouterProvider.otherwise('/swastik/landing');
        ...
        // @endif
            ...
            // Swastik Hospital Clinical Module - mock data, no backend
            $stateProvider
            .state('swastik', {
                abstract: true,
                url: '/swastik',
                views: {
                    'content@': {
                        template: '<div ui-view="swastik-content"></div>'
                    }
                }
            })
            .state('swastik.landing', {
                url: '/landing',
                views: {
                    'swastik-content@swastik': {
                        templateUrl: 'swastik/views/clinicalLanding.html',
                        controller: 'SwastikClinicalLandingController'
                    }
                }
            })
            .state('swastik.workspace', {
                url: '/workspace/:patientUuid',
                views: {
                    'swastik-content@swastik': {
                        templateUrl: 'swastik/views/clinicalWorkspace.html',
                        controller: 'SwastikClinicalWorkspaceController'
                    }
                }
            })
            .state('search', {
